...
| CLI | `app.cli.ask` supports text/json output, streaming event display, quiet/verbose modes, sessions, structured caller fields, runtime constraints, max steps, and reset. | [README.md](../README.md), [react_integration_guide.md](react_integration_guide.md) |
